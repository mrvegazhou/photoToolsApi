...
from core.log.logger import TimeInspector, get_module_logger
from ...common.typehint import Literal
...
class DataHandler(Serializable):
    ...
    def __init__(
        ...
        # {'class': 'QlibDataLoader', 'kwargs': {'config': {'feature': (['($close-$open)/$open',....
        # what data source to load data
