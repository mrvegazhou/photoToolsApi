...
from modules.datas.realTimeData.eastStockRealTime import EastStockRealTime
from modules.datas.realTimeData.sinaStockRealTime import SinaStockRealTime
from modules.datas.realTimeData.netEaseStockRealTime import NetEaseStockRealTime
#
if __name__ == "__main__":
#     # sina = Sina()
#     # print(sina.real(['002004'， ‘002603’]))
#     east = EastStockRealTime()
#     df = east.get_stock_real_time(['xx', 'ddd'], full=False)
#     print(df)
#     print('\n')
