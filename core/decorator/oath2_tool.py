...
from stock_admin.__init__ import current_app, request, utils
from ..__init__ import cache, g
...
def need_login(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        # 判断token环境是否改变
        identifier = utils['common'].get_client_ident(g.get("client_info"))
...
def create_token(user_id, password, client_info=""):
    ...
    user_ident = utils['common'].get_client_ident(client_info)
